...
public class gameproject {
    public static void main(String[] args) {
		...
		String a = "y", b = "Y";
		String c = "n", d = "N";
		//스캐너 선언과 값을 입력받을 start 변수, start변수와 equals함수로 비교할 a, b, c, d 변수 선언과 값 입력
		do{
			start = "";
		...
		} while(!c.equals(start) || !d.equals(start) || !a.equals(start) || !b.equals(start)); // y 또는 Y 와 n 또는 N 이 아니라면 while 문을 반복 실행
		scan.close(); 
}
	...
	//게임 진행 메소드
		...
		//스캐너 선언과 값을 입력받을 action 변수, action변수와 equals함수로 비교할 a, b, c, d 변수 선언과 값 입력
